...
<head>
<meta charset="UTF-8">
<link href="${pageContext.request.contextPath}/resources/transaction.css"
	rel="stylesheet" />
...
<ul class="mobileNavBar">
	...
	<div class="flexContainer">
		...
		<div class="flexItem">
			<form:form action="${request.getContextPath()}/atmOperation"
				modelAttribute="Atm" method="POST">
...
<form:select path="account" required="true">
 ...
 Amount: <form:input path="amount" required="true" />
				<br>
